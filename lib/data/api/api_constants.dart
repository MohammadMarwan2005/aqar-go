class APIConstants {
  ...
  static const String getTelegramLinkUrl = "$baseUrl/telegram/link";
  static const String getTelegramUsernameUrl = "$baseUrl/telegram/username";
  static const String getAqarGoLinksUrl = "$baseUrl/links";
