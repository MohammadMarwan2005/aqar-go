...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CheckPasswordOtpState);
}
...
/// @nodoc
class $CheckPasswordOtpStateCopyWith<$Res>  {
$CheckPasswordOtpStateCopyWith(CheckPasswordOtpState _, $Res Function(CheckPasswordOtpState) __);
}
...
class _Initial implements CheckPasswordOtpState {
  const _Initial();
...
@override
String toString() {
  return 'CheckPasswordOtpState.initial()';
}
...
class _Loading implements CheckPasswordOtpState {
  const _Loading();
...
@override
String toString() {
  return 'CheckPasswordOtpState.loading()';
}
...
class _Success implements CheckPasswordOtpState {
  const _Success(this.responseData);
  

 final  AuthResponseData responseData;

/// Create a copy of CheckPasswordOtpState
...
@override
String toString() {
  return 'CheckPasswordOtpState.success(responseData: $responseData)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $CheckPasswordOtpStateCopyWith<$Res> {
...
class _Error implements CheckPasswordOtpState {
...
@override
String toString() {
  return 'CheckPasswordOtpState.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CheckPasswordOtpStateCopyWith<$Res> {
...
class _InvalidInput implements CheckPasswordOtpState {
...
@override
String toString() {
  return 'CheckPasswordOtpState.invalidInput(onProceed: $onProceed)';
}
...
/// @nodoc
abstract mixin class _$InvalidInputCopyWith<$Res> implements $CheckPasswordOtpStateCopyWith<$Res> {
