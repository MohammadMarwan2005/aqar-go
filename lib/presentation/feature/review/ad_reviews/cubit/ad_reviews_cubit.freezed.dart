...
class _Success implements AdReviewsState {
  const _Success(final  List<Review> reviews): _reviews = reviews;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Success&&const DeepCollectionEquality().equals(other._reviews, _reviews));
}
...
@override
String toString() {
  return 'AdReviewsState.success(reviews: $reviews)';
}
